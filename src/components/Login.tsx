...
//       // Save ALL authentication data - FIXED: Now saving token!
//       localStorage.setItem("token", response.data.token || response.data.accessToken || response.data.jwt);
//       localStorage.setItem("user", JSON.stringify(response.data.user || response.data));
//       localStorage.setItem("userName", response.data.user?.name || response.data.name || email);
//       localStorage.setItem("auth", "true");
...
const Login: React.FC = () => {
  ...
  const handleLogin = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Save ALL authentication data including role
      localStorage.setItem("token", response.data.token || response.data.accessToken || response.data.jwt);
      ...
      console.log("✅ Full user data saved:", response.data);
